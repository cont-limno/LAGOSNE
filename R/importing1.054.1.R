...
epi.nutr <- read.table("lagos_epi_nutr_10541.txt", 
                       header = TRUE, 
                       sep = "\t", 
                       quote = "", 
                       dec = ".", 
...
lake.specific <- read.table("lagos_lakes_10541.txt", 
                            header = TRUE, 
                            sep = "\t", 
                            quote = "", 
                            dec = ".", 
...
secchi <- read.table('lagos_secchi_10541.txt', 
                     header =T,
                     sep = "\t",
                     quote = "",
                     dec = ".",
...
lagos.source <- read.table('lagos_source_10541.txt', 
                           header =T,
                           sep = "\t",
                           quote = "",
                           dec = ".",
...
county <- read.table("county.txt", header =T,
                     sep = "\t",
                     quote= "",
                     dec = "." ,
                     strip.white = TRUE,
...
county.chag <-  read.table("county_chag.txt", header =T,
                           sep = "\t",
                           quote= "",
                           dec = "." ,
                           strip.white = TRUE,
...
county.conn <-  read.table("county_conn.txt", header =T,
                           sep = "\t",
                           quote= "",
                           dec = "." ,
                           strip.white = TRUE,
...
county.lulc <-  read.table("county_lulc.txt", header =T,
                           sep = "\t",
                           quote= "",
                           dec = "." ,
                           strip.white = TRUE,
...
edu <- read.table("edu.txt", header =T,
                  sep = "\t",
                  quote= "",
                  dec = "." ,
                  strip.white = TRUE,
...
edu.chag <-  read.table("edu_chag.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
edu.conn <-  read.table("edu_conn.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
edu.lulc <-  read.table("edu_lulc.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
hu4 <- read.table("hu4.txt", header =T,
                  sep = "\t",
                  quote= "",
                  dec = "." ,
                  strip.white = TRUE,
...
hu4.chag <-  read.table("hu4_chag.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
hu4.conn <-  read.table("hu4_conn.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
hu4.lulc <-  read.table("hu4_lulc.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
hu8 <- read.table("hu8.txt", header =T,
                  sep = "\t",
                  quote= "",
                  dec = "." ,
                  strip.white = TRUE,
...
hu8.chag <-  read.table("hu8_chag.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
hu8.conn <-  read.table("hu8_conn.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
hu8.lulc <-  read.table("hu8_lulc.txt", header =T,
                        sep = "\t",
                        quote= "",
                        dec = "." ,
                        strip.white = TRUE,
...
hu12 <- read.table("hu12.txt", header =T,
                   sep = "\t",
                   quote= "",
                   dec = "." ,
                   strip.white = TRUE,
...
hu12.chag <-  read.table("hu12_chag.txt", header =T,
                         sep = "\t",
                         quote= "",
                         dec = "." ,
                         strip.white = TRUE,
...
hu12.conn <-  read.table("hu12_conn.txt", header =T,
                         sep = "\t",
                         quote= "",
                         dec = "." ,
                         strip.white = TRUE,
...
hu12.lulc <-  read.table("hu12_lulc.txt", header =T,
                         sep = "\t",
                         quote= "",
                         dec = "." ,
                         strip.white = TRUE,
...
iws <- read.table("iws.txt", header =T,
                  sep = "\t",
                  quote= "",
                  dec = "." ,
                  strip.white = TRUE,
...
iws.conn <- read.table("iws_conn.txt", header =T,
                       sep = "\t",
                       quote= "",
                       dec = "." ,
                       strip.white = TRUE,
...
iws.lulc <- read.table("iws_lulc.txt", header =T,
                       sep = "\t",
                       quote= "",
                       dec = "." ,
                       strip.white = TRUE,
...
state <- read.table("state.txt", header =T,
                    sep = "\t",
                    quote= "",
                    dec = "." ,
                    strip.white = TRUE,
...
state.chag <-  read.table("state_chag.txt", header =T,
                          sep = "\t",
                          quote= "",
                          dec = "." ,
                          strip.white = TRUE,
...
state.conn <-  read.table("state_conn.txt", header =T,
                          sep = "\t",
                          quote= "",
                          dec = "." ,
                          strip.white = TRUE,
...
state.lulc <-  read.table("state_lulc.txt", header =T,
                          sep = "\t",
                          quote= "",
                          dec = "." ,
                          strip.white = TRUE,
...
#######################
# buffer
lakes4ha.buffer100m <- read.table("lakes4ha_buffer100m.txt", header =T,
                                  sep = ",",
                                  quote= "",
                                  dec = "." ,
                                  strip.white = TRUE,
...
lakes4ha.buffer100m.lulc <- read.table("lakes4ha_buffer100m_lulc.txt", header =T,
                                       sep = "\t",
                                       quote= "",
                                       dec = "." ,
                                       strip.white = TRUE,
...
lakes4ha.buffer500m <- read.table("lakes4ha_buffer500m.txt", header =T,
                                  sep = ",",
                                  quote= "",
                                  dec = "." ,
                                  strip.white = TRUE,
...
lakes4ha.buffer500m.conn <- read.table("lakes4ha_buffer500m_conn.txt", header =T,
                                       sep = "\t",
                                       quote= "",
                                       dec = "." ,
                                       strip.white = TRUE,
...
lakes4ha.buffer500m.lulc <- read.table("lakes4ha_buffer500m_lulc.txt", header =T,
                                       sep = "\t",
                                       quote= "",
                                       dec = "." ,
                                       strip.white = TRUE,
...
lagoslakes <-  read.table("lagoslakes_10400.txt", header =T,
                          sep = "\t",
                          quote= "",
                          dec = "." ,
                          strip.white = TRUE,
